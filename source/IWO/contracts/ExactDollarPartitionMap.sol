...
library ExactDollarPartitionMap {
    ...
    function finalizeScoreMap(Scores.ScoreMap storage scoreMap, uint[][] storage partition,uint width) external{
        uint[][] memory part = Zipper.unzipMatrix(partition,width);
    ...
    /// @param width width of the indices
